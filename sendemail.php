...
$subject = "Booking form submitted from website";
$body = "Name: " . $_POST['fname'] . "\r\n\r\n";
$body .= "Email: " . $_POST['email'] . "\r\n\r\n";
$body .= "Contact Number: " . $_POST['number'] . "\r\n\r\n";
$body .= "Area: " . $_POST['area'] . "\r\n\r\n";
$body .= "Pets: " . $_POST['pets'] . "\r\n\r\n";
$body .= "Booking date: " . $_POST['datemin'] . "\r\n\r\n";
$body .= "End of booking date: " . $_POST['datemax'];
...
<body>
    ...
    <p class="message">*Please note a booking is not confirmed until you receive an email directly from us*</p>
        <?php } ?>
    <footer id="footer">
        <div id="social">
